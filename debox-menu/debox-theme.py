...
from PyQt5.QtGui import QIcon, QPalette, QColor, QFont, QPixmap, QBrush

class GLIBCManager(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("DEBOX 管理器")
        self.setFixedSize(850, 470)
        self.center_window()
        ...
        # 设置背景图片 - 保持不透明
        wallpaper_path = os.path.join(self.icon_path, "wallpaper.png")
        if os.path.exists(wallpaper_path):
            main_widget.setAutoFillBackground(True)
            palette = main_widget.palette()
            # 使用QBrush包装QPixmap
            brush = QBrush(QPixmap(wallpaper_path))
        ...
        self.interaction_title.setStyleSheet("font-size: 16px; padding: 10px; color: #000000; background-color: transparent;")
        ...
        self.log_text.setStyleSheet("font-size: 11px; color: #000000;")
        self.log_text.hide()
    ...
    def execute_start_window(self, resolution):
        ...
        # 修复：使用正确的startonwine参数格式
        cmd = f"ssh -p 8022 127.0.0.1 startonwine -d{resolution} /data/data/com.termux/files/usr/glibc/opt/apps/tfm.exe -b -5"
    ...
    def start_fullscreen_mode(self):
        try:
            ...
            cmd = [
                ...
                "/data/data/com.termux/files/usr/glibc/opt/apps/tfm.exe"
            ]
    ...
    def uninstall_all(self):
        ...
        info_label.setStyleSheet("font-size: 16px; color: #000000; background-color: transparent;")
    ...
    def reset_wine_prefix(self):
        ...
        path_label.setStyleSheet("font-size: 14px; color: #666; background-color: transparent;")
    ...
    def dynarec_custom_mode(self):
        ...
        for name, default, range_text in default_options:
            ...
            spin.setStyleSheet("color: #000000; background-color: transparent; border: 1px solid #a0a0a0; border-radius: 5px;")
    ...
    def dynarec_preset_mode(self):
        ...
        input_label.setStyleSheet("font-size: 14px; color: #000000; background-color: transparent;")
        ...
        self.preset_input.setStyleSheet("color: #000000; background-color: transparent; border: 1px solid #a0a0a0; border-radius: 5px;")
        ...
        preset_info.setStyleSheet("color: #000000; background-color: transparent;")
    ...
    def set_cpu_cores(self):
        ...
        for i, (text, value) in enumerate(modes):
            ...
            radio.setStyleSheet("QRadioButton { font-size: 14px; color: #000000; background-color: transparent; }")
