...
public class ProgressBarBlue {
    private JFrame frame;
    private JProgressBar progressBar;
    private JLabel label;
    private volatile boolean running = true;
    
    public ProgressBarBlue(String title) {
        // 直接在EDT中创建GUI
        ...
        progressBar = new JProgressBar(0, 100) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (getValue() > 0) {
                    ...
                    // 渐变蓝色
                    GradientPaint gradient = new GradientPaint(0, 0, new Color(70, 130, 255), 
                                                              width, 0, new Color(30, 100, 255));
                    g2d.setPaint(gradient);
                    g2d.fillRoundRect(1, 1, width - 2, getHeight() - 2, 8, 8);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            final ProgressBarBlue pb = new ProgressBarBlue(title);
